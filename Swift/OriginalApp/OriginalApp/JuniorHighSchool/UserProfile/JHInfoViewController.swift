...
class JHInfoViewController: UIViewController,  UITextFieldDelegate, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource, userQuestionTableViewCellDelegate{
    ...
    override func viewDidLoad() {
        ...
        questionHistoryTableView.reloadData()
       ...
       //ImageViewを丸くするコード
        ...
        let nib = UINib(nibName: "userQuestionTableViewCell", bundle: Bundle.main)
        questionHistoryTableView.register(nib, forCellReuseIdentifier: "Cell")
        questionHistoryLabel.backgroundColor = UIColor(hex: "FFC042")
        questionHistoryLabel.textColor = UIColor.white
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let user = NCMBUser.current() {
            ...
            firstSchoolLabel.text = user.object(forKey: "firstSchool") as? String
            secondSchoolLabel.text = user.object(forKey: "secondSchool") as? String
            thirdSchoolLabel.text = user.object(forKey: "thirdSchool") as? String
            fourthSchoolLabel.text = user.object(forKey: "fourthSchool") as? String
            fifthSchoolLabel.text = user.object(forKey: "fifthSchool") as? String
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell") as! userQuestionTableViewCell
        cell.delegate = self
       ...
       // let userImageUrl = "https://mb.api.cloud.nifty.com/2013-09-01/applications/rcsyyu9UuijtnCy5/publicFiles/" + user.objectId
        ...
        cell.userPostTextView.text = userPosts[indexPath.row].text
        //let imageUrl = userPosts[indexPath.row].imageUrl
        
        
        cell.userPostTimeLineLabel.text = DateUtils.stringFromDate(date: userPosts[indexPath.row].createDate, format: "yyyy年MM月dd日 HH時mm分")
